...
Page {
    title: "All item produced by " + producerName + " page " + HalalJapanAPI.itemListModel.currentPage
    property int producerId: 0
    property string producerName: "producer"

    function gotoPage(selectedPage) {
        toggleBusy(true);
        HalalJapanAPI.getItemByProducer(producerName, selectedPage, Settings.itemPerPage);
    }
